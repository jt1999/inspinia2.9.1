...
$$1.extend($$1.summernote.lang, {
    ...
    'en-ZH': {
        ...
        help: {
            ...
            'formatH1': '将当前块的格式更改为H1',
            'formatH2': '将当前块的格式更改为HH2',
            'formatH3': '将当前块的格式更改为H3',
            'formatH4': '将当前块的格式更改为H4',
            'formatH5': '将当前块的格式更改为H5',
            'formatH6': '将当前块的格式更改为H6',
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        toolbar: [
            ...
            ['fontname', ['fontname']],
            ['color', ['color']],
            ['para', ['ul', 'ol', 'paragraph','height','undo','redo']],
            ['table', ['table']],
